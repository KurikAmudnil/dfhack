...
-- changed criteria, isSane acounts for dead and opposed to life
...
function cbHireGuard(reaction,unit,input_items,input_reagents,output_items,call_native)
	...
	for i=#v-1,0,-1 do	-- search list in reverse, guards are probably nearer the end of the list
		u = v[i]
		if u.flags1.forest and dfhack.units.isSane(u) and dfhack.units.isDwarf(u) and 
					not u.flags1.caged and isSeen(view,u.pos) and 
					not u.flags1.merchant and not u.flags1.diplomat then
